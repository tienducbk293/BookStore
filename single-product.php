...
<head>
   ...
   <link rel="stylesheet" href="css/custom.css">
	...
	<!-- Modernizer js -->
	<script src="../Book/public/js/js/vendor/modernizr-3.5.0.min.js"></script>
</head>
<body>
	<!--[if lte IE 9]>
	...
	<div class="wrapper" id="wrapper">
				...
				<div class="row">
					...
					<div class="col-lg-8 d-none d-lg-block">
						<nav class="mainmenu__nav">
							<ul class="meninmenu d-flex justify-content-start">
								...
								<li class="drop"><a href="single-product.php#">Shop</a>
								...
								<li class="drop"><a href="single-product.php#">Pages</a>
									<div class="megamenu dropdown">
										<ul class="item item01">
					...
					<div class="col-md-8 col-sm-8 col-5 col-lg-2">
						<ul class="header__sidebar__right d-flex justify-content-end align-items-center">
							<li class="shop_search"><a class="search__active" href="single-product.php#"></a></li>
							<li class="wishlist"><a href="single-product.php#"></a></li>
							<li class="shopcart"><a class="cartbox_active" href="single-product.php#"><span class="product_qun">3</span></a>
								<!-- Start Shopping Cart -->
													...
													<div class="content">
														...
														<div class="product_prize d-flex justify-content-between">
															...
															<ul class="d-flex justify-content-end">
																<li><a href="single-product.php#"><i class="zmdi zmdi-settings"></i></a></li>
																<li><a href="single-product.php#"><i class="zmdi zmdi-delete"></i></a></li>
															</ul>
														</div>
													</div>
												</div>
							...
							<li class="setting__bar__icon"><a class="setting__active" href="single-product.php#"></a>
											...
											<div class="switcher-options">
												<div class="switcher-currency-trigger">
													<div class="setting__menu">
														<span><a href="single-product.php#">Compare Product</a></span>
														<span><a href="single-product.php#">My Account</a></span>
														<span><a href="single-product.php#">My Wishlist</a></span>
														<span><a href="single-product.php#">Sign In</a></span>
														<span><a href="single-product.php#">Create An Account</a></span>
													</div>
												</div>
											</div>
										</div>
					...
					<div class="col-lg-12 d-none">
						<nav class="mobilemenu__nav">
							<ul class="meninmenu">
								...
								<li><a href="single-product.php#">Pages</a>
									<ul>
										<li><a href="about.html">About Page</a></li>
		...
		<div class="box-search-content search_active block-bg close__top">
			<form id="search_mini_form" class="minisearch" action="single-product.php#">
        			...
        			<div class="col-lg-9 col-12">
        						...
        						<div class="col-lg-6 col-12">
        							<div class="wn__fotorama__wrapper">
	        							<div class="fotorama wn__fotorama__action" data-nav="thumbs">
		        							  <a href="http://demo.devitems.com/boighor-v2/1.jpg"><img src="images/product/1.jpg" alt=""></a>
		        							  <a href="http://demo.devitems.com/boighor-v2/2.jpg"><img src="images/product/2.jpg" alt=""></a>
		        							  <a href="http://demo.devitems.com/boighor-v2/3.jpg"><img src="images/product/3.jpg" alt=""></a>
		        							  <a href="http://demo.devitems.com/boighor-v2/4.jpg"><img src="images/product/4.jpg" alt=""></a>
		        							  <a href="http://demo.devitems.com/boighor-v2/5.jpg"><img src="images/product/5.jpg" alt=""></a>
		        							  <a href="http://demo.devitems.com/boighor-v2/6.jpg"><img src="images/product/6.jpg" alt=""></a>
		        							  <a href="http://demo.devitems.com/boighor-v2/7.jpg"><img src="images/product/7.jpg" alt=""></a>
		        							  <a href="http://demo.devitems.com/boighor-v2/8.jpg"><img src="images/product/8.jpg" alt=""></a>
	        							</div>
        							</div>
        						</div>
        						<div class="col-lg-6 col-12">
        				...
        				<div class="product__info__detailed">
							<div class="pro_details_nav nav justify-content-start" role="tablist">
	                            <a class="nav-item nav-link active" data-toggle="tab" href="single-product.php#nav-details" role="tab">Details</a>
	                            <a class="nav-item nav-link" data-toggle="tab" href="single-product.php#nav-review" role="tab">Reviews</a>
	                        </div>
							...
							<div class="footer__widget footer__menu">
								...
								<div class="footer__content">
									<ul class="social__net social__net--2 d-flex justify-content-center">
										<li><a href="single-product.php#"><i class="bi bi-facebook"></i></a></li>
										<li><a href="single-product.php#"><i class="bi bi-google"></i></a></li>
										<li><a href="single-product.php#"><i class="bi bi-twitter"></i></a></li>
										<li><a href="single-product.php#"><i class="bi bi-linkedin"></i></a></li>
										<li><a href="single-product.php#"><i class="bi bi-youtube"></i></a></li>
									</ul>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="copyright">
								<div class="copy__right__inner text-left">
									<p>Copyright <i class="fa fa-copyright"></i> <a href="single-product.php#">Boighor.</a> All Rights Reserved</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
		                    ...
		                    <div class="modal-product">
		                        ...
		                        <div class="product-info">
		                            ...
		                            <div class="rating__and__review">
		                                ...
		                                <div class="review">
		                                    <a href="single-product.php#">4 customer reviews</a>
		                                </div>
		                            </div>
		                            ...
		                            <div class="select__color">
		                                ...
		                                <ul class="color__list">
		                                    <li class="red"><a title="Red" href="single-product.php#">Red</a></li>
		                                    <li class="gold"><a title="Gold" href="single-product.php#">Gold</a></li>
		                                    <li class="orange"><a title="Orange" href="single-product.php#">Orange</a></li>
		                                    <li class="orange"><a title="Orange" href="single-product.php#">Orange</a></li>
		                                </ul>
		                            </div>
		                            <div class="select__size">
		                                <h2>Select size</h2>
		                                <ul class="color__list">
		                                    <li class="l__size"><a title="L" href="single-product.php#">L</a></li>
		                                    <li class="m__size"><a title="M" href="single-product.php#">M</a></li>
		                                    <li class="s__size"><a title="S" href="single-product.php#">S</a></li>
		                                    <li class="xl__size"><a title="XL" href="single-product.php#">XL</a></li>
		                                    <li class="xxl__size"><a title="XXL" href="single-product.php#">XXL</a></li>
		                                </ul>
		                            </div>
		                            <div class="social-sharing">
		                                <div class="widget widget_socialsharing_widget">
		                                    ...
		                                    <ul class="social__net social__net--2 d-flex justify-content-start">
		                                        <li class="facebook"><a href="single-product.php#" class="rss social-icon"><i class="zmdi zmdi-rss"></i></a></li>
		                                        <li class="linkedin"><a href="single-product.php#" class="linkedin social-icon"><i class="zmdi zmdi-linkedin"></i></a></li>
		                                        <li class="pinterest"><a href="single-product.php#" class="pinterest social-icon"><i class="zmdi zmdi-pinterest"></i></a></li>
		                                        <li class="tumblr"><a href="single-product.php#" class="tumblr social-icon"><i class="zmdi zmdi-tumblr"></i></a></li>
		                                    </ul>
		                                </div>
		                            </div>
		                            <div class="addtocart-btn">
		                                <a href="single-product.php#">Add to cart</a>
		                            </div>
		                        </div><!-- .product-info -->
		                    </div><!-- .modal-product -->
		                </div><!-- .modal-body -->
	...
	<!-- JS Files -->
	<script src="../Book/public/js/js/vendor/jquery-3.2.1.min.js"></script>
	<script src="../Book/public/js/js/popper.min.js"></script>
	<script src="../Book/public/js/js/bootstrap.min.js"></script>
	<script src="../Book/public/js/js/plugins.js"></script>
	<script src="../Book/public/js/js/active.js"></script>
