                ...
                <div class="col-lg-9 col-12 order-1 order-lg-2">
                    ...
                    <div class="tab__container">
                        <div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
                            <div class="row">
                            @if($amount > 9)
                                @foreach($paginate_books as $id => $books)
                                    @foreach($books as $key => $book)
                                        <!-- Start Single Product -->
                                        <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="product__thumb">
                                                <a class="first__img" href="{{ route('detail', $book[$key]['book_id']) }}"><img src="{{ @$book[$key]['image'] }}" alt="product image"></a>
                                                <div class="hot__box">
                                                    <span class="hot-label">SALE</span>
                                                </div>
                                            </div>
                                            <div class="product__content content--center">
                                                <h4><a href="#">{{ @$book[$key]['title'] }}</a></h4>
                                                <ul class="prize d-flex">
                                                    <li>{{ @$book[$key]['final_price'] }}</li>
                                                    <li class="old_prize">{{ @$book[$key]['price_regular'] }}</li>
                                                </ul>
                            ...
                            @else
                                @foreach($category_books as $key => $book)
                                <!-- Start Single Product -->
                                    <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="product__thumb">
                                            <a class="first__img" href="{{ route('detail', $book[$key]['book_id']) }}"><img src="{{ @$book[$key]['image'] }}" alt="product image"></a>
